...
public class trabajos_propuestos_IV {
    static Scanner input = new Scanner(System.in);
    public static void ejercicio01() {
        int salario = 1500;
        for (int i = 1; i <= 6; i++) {
            salario += salario*0.10;
            System.out.println("El salario al cabo de "+ i +" año es: "+ salario);
        }
    }
    ...
    public static void ejercicio06() {
        ...
        for (int i = 1; i <= valor; i++) {
            System.out.println("Ingresa el "+i+" número: ");
            num = input.nextInt();
    ...
    public static void ejercicio09() {
        ...
        for (int a = 1; a <= años; a++){
            ...
            for (int i = 1; i <= 12; i++) {
                ...
                x = input.nextDouble();
                total += x;
                System.out.println("La inversión del mes " + i + " es: " + total);
            }
            total += total * 0.10;
            System.out.println("El total del "+a+" años es: "+ total);
            total -= total;
        }
    }
